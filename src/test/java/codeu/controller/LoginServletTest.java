...
public class LoginServletTest {
  ...
  public void testDoPost_NonExistingUser() throws IOException, ServletException {
    ...
    Mockito.verify(mockUserStore).isUserRegistered("test username");
    Mockito.verify(mockRequest).setAttribute("error", "That username was not found.");

  }

  @Test
  public void testDoPost_ExistingUser_CorrectPW() throws IOException, ServletException {
    Mockito.when(mockRequest.getParameter("username")).thenReturn("test username");
  ...
  @Test
  public void testDoPost_ExistingUser_IncorrectPW() throws IOException, ServletException {
    Mockito.when(mockRequest.getParameter("username")).thenReturn("test username");
    Mockito.when(mockRequest.getParameter("password")).thenReturn("test password");
