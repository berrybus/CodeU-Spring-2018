...
public class ProfileServlet extends HttpServlet {
  ...
  /**
   * This function fires when a user navigates to the profile page. It gets the username from
   * the URL, finds the corresponding user, and fetches the messages that user has sent, along with their "about" information.
  ...
  /**
   * This function fires when a user submits the about me form on their profile page. It it updates the about me for that user and then
   * redirects back to the profile page.
   * Should only be able to post if a user is on their own profile page.
   */
  @Override
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (username == null) {
      // user is not logged in, don't let them update
    ...
    User user = userStore.getUser(username);
    if (user == null) {
      // user was not found, don't let them update
      response.sendRedirect("/login");
      return;
    }
