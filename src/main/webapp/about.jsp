    ...
    <div
      ...
      <ul>
        ...
        <li><strong>Customization:</strong> Think about a group you care about.
          ...
          <li><strong>Our Developers:</strong> We are a team of university students aiming to improve our development skills by working with standard industry practices under the direction and aid of Google software engineers(P0).</li>
      </ul>
